...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QBoard_t, stringdata0) + ofs \
...
QT_MOC_LITERAL(4, 18, 4), // "undo"
QT_MOC_LITERAL(5, 23, 15), // "on_hint_clicked"
QT_MOC_LITERAL(6, 39, 15), // "handleStockDeck"
QT_MOC_LITERAL(7, 55, 8), // "showTime"
QT_MOC_LITERAL(8, 64, 10) // "removeGame"

    },
    "QBoard\0save\0\0load\0undo\0on_hint_clicked\0"
    "handleStockDeck\0showTime\0removeGame"
};
...
void QBoard::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: _t->on_hint_clicked(); break;
        case 4: _t->handleStockDeck(); break;
        case 5: _t->showTime(); break;
        case 6: _t->removeGame(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObject QBoard::staticMetaObject = {
    { &QFrame::staticMetaObject, qt_meta_stringdata_QBoard.data,
...
void *QBoard::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QBoard.stringdata0))
